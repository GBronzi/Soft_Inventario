...
export function UpdateNotifier() {
  ...
  return (
    <div className="fixed inset-0 z-50 flex items-end justify-center bg-black/35 p-4 backdrop-blur-[2px] sm:items-center" role="dialog" aria-modal="true" aria-labelledby="update-title">
      <section className="relative w-full max-w-2xl overflow-hidden rounded-2xl border border-white/20 bg-background shadow-2xl">
        ...
        <div className="max-h-[62vh] overflow-y-auto p-5">
          ...
          <div className="mt-5 space-y-4">
            {notes.length ? notes.map((section) => (
              <div key={section.title} className="rounded-xl border bg-card/70 p-4">
              ...
              <div className="rounded-xl border bg-card/70 p-4 text-sm text-muted-foreground">Esta version incluye mejoras y correcciones generales.</div>
            )}
          </div>
