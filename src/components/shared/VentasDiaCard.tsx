  ...
  return (
    <Card className="overflow-hidden border-border/50 bg-card/60 shadow-xl backdrop-blur-sm">
      ...
      {open && <CardContent className="p-0">
        {!summary?.detalles.length ? <div className="p-8 text-center text-sm text-muted-foreground">Todavía no hay ventas registradas hoy.</div> : <div className="liquid-table-container overflow-x-auto">
          <table className="operational-table w-full min-w-[720px] text-sm">
